...
from app.schemas import ExercisePayloadSchema, ExerciseSchema
...
async def create_exercise(payload: ExercisePayloadSchema) -> ExerciseSchema:
    exercise = await crud.post_exercise(payload)
    return exercise
